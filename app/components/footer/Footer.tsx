...
export const Footer = () => {
    const year = new Date();
    return (
        <div className="sticky top-[100vh] text-center bg-indigo-200 dark:bg-indigo-800 py-4">
            <div className="">
                <Container>
                    <div className="pt-6">
                        <div>
                        ...
                        <div className='flex justify-center gap-x-4 text-xl mt-6'>
                            ...
                            <Link aria-label="Whatsapp" href="/" target='_Blank' className='text-indigo-950 dark:text-neutral-200 hover:text-indigo-800 dark:hover:text-white'><BsWhatsapp/></Link>
                        </div>
